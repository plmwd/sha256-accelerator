...
HD_PWD='C:/Users/904pa/Documents/Git/sha256/project/sha256.runs/test_axi_timer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_axi_timer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_axi_timer_0_0.tcl
