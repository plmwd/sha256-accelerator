...
HD_PWD='C:/Users/904pa/Documents/Git/sha256/project/sha256_accelerator/sha256_accelerator.runs/cpu_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_lmb_bram_0.tcl
